    ...
    <section class="tp-banner-container">
        <div class="tp-banner">
            <ul>
                <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                    ...
                    <img src="{{asset('assets/img/slide/service1.jpeg')}}" alt="fullslide1" data-bgposition="center center"
                        data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                        data-bgfitend="100" data-bgpositionend="right center">
                </li>
                <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                    data-saveperformance="off" data-title="Slide">
                    <img src="{{asset('assets/img/slide/electrician.jpg')}}" alt="fullslide1" data-bgposition="top center"
                        data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                        data-bgfitend="100" data-bgpositionend="right center">
                </li>
            </ul>
        ...
        <div class="filter-title">
            <div class="title-header">
                <h2 style="color:rgb(220, 211, 211);">BOOK A SERVICE</h2>
                <p class="lead">We provide best services</p>
            </div>
            <div class="filter-header">
                <form id="sform" action="searchservices" method="post">
                    <input type="text" id="q" name="q" required="required" placeholder="search"
    ...
    <section class="content-central">
        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2 style="color: lightseagreen">AC Services</h2>
        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="titles">
                        <h2 style="color: lightseagreen">Popular Services</h2>
                        <i class="fa fa-plane"></i>
                        <hr class="tall">
                    </div>
                </div>
