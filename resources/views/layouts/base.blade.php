...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/img/myylogo.png')}}">
    ...
    {{-- <div id="layout"> --}}
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="/"><img src="{{asset('images/myylogo.png')}}"></a>
                    </li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#">Thalassery,kerala</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">naseefmottath@gmail.com</a>
                            </li>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">naseefmottath@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
